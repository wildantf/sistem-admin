...
<div class="container">
    <div class="row">
        <div class="col-8">
            <form action="<?= route_to('post.create'); ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-2">
                        <img src="<?= '/img/default.jpg'; ?>" class="img-thumbnail image-preview" alt="">
                    </div>
                    <div class="col-sm-10">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $validation->hasError('body') ? 'is-invalid' : ''; ?>" id="body" name="body" rows="3"><?= old('body'); ?></textarea>
